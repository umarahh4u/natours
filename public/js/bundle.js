...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoidW1hcmFoaDR1IiwiYSI6ImNsNXdkc3gxbDBpcW4za284NHBkZDBvNWkifQ.0scXacvHqa26SIloqLA5jA';
...
exports.lougout = exports.login = void 0;
        ...
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'Success') {
              ...
              (0, _alert.showAlert)('error', 'Invalid details');
            }
...
var lougout = /*#__PURE__*/function () {
  ...
  return function lougout() {
    return _ref2.apply(this, arguments);
  };
}();

exports.lougout = lougout;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            _context.next = 7;
            return (0, _stripeJs.loadStripe)('pk_test_51LQLRZD5viAyeGiykTSXdOvJPVdwxv1fzxZBI68SxhpMfrAhcPqbDTAzbJUADSP6UvXiVxXgGWPSkyYWVz8so3ah00ZO5FdwGV');
...
if (logOutBtn) logOutBtn.addEventListener('click', _login.lougout);
...
if (userDataForm) {
  userDataForm.addEventListener('submit', function (e) {
    ...
    form.append('photo', document.getElementById('photo').files[0]); // values

    (0, _updateSettings.updateSettings)(form, 'data'); //console.log(form);
  });
}
