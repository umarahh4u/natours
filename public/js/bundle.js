parcelRequire = (function (e, r, t, n) {
...
})(
  {
          ...
          o.forEach(function (o) {
            ...
            (t.className = 'maker'),
              ...
              new mapboxgl.Popup({ offset: 30 })
                .setLngLat(o.coordinates)
                .setHTML('<p> Day '.concat(o.day, ': ').concat(o.description))
                .addTo(a),
                    ...
                    switch ((e.prev = e.next)) {
                      ...
                      case 3:
                        'Success' === e.sent.data.status
                          ...
                          : (0, r.showAlert)('error', 'Invalid details'),
                          (e.next = 10);
                        break;
                      case 7:
                        (e.prev = 7),
                ...
                function (e) {
                  for (;;)
                    switch ((e.prev = e.next)) {
                      ...
                      case 4:
                        e.sent.data.status.includes('uccess') &&
                          ((0, r.showAlert)(
                            'success',
                            ''.concat(i.toUpperCase(), ' successfuly updated')
                          ),
                          window.setTimeout(function () {
                            location.assign('/me');
                          }, 1500)),
    ...
    Uj2q: [
      ...
      { axios: 'uj17', '@stripe/stripe-js': 'rS9U', './alert': 'acK6' },
    ],
    Focm: [
      function (require, module, exports) {
        'use strict';
        ...
        var c = document.getElementById('map'),
          ...
          l = document.querySelector('.nav_el--logout'),
        ...
        a &&
          ...
          l && l.addEventListener('click', r.lougout),
          d &&
